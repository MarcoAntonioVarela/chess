...
void Board::reset()
{
   ...
   // Black pieces
   board[7][0] = new Rook(Position("a8"), false);
   board[7][1] = new Knight(Position("b8"), false);
   board[7][2] = new Bishop(Position("c8"), false);
   board[7][3] = new Queen(Position("d8"), false);
   board[7][4] = new King(Position("e8"), false);
   board[7][5] = new Bishop(Position("f8"), false);
   board[7][6] = new Knight(Position("g8"), false);
   ...
   board[0][1] = new Knight(Position("b1"), true);
   board[0][2] = new Bishop(Position("c1"), true);
   board[0][3] = new Queen(Position("d1"), true);
   board[0][4] = new King(Position("e1"), true);
   board[0][5] = new Bishop(Position("f1"), true);
   board[0][6] = new Knight(Position("g1"), true);
   board[0][7] = new Rook(Position("h1"), true);
}
